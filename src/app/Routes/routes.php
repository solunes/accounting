...
Route::group(['prefix'=>'gitlab'], function(){
    Route::get('/group-accountings/{group_name}', 'GitlabController@getGroupAccountings');
    Route::get('/accounting/{accounting_name}/{group_name}', 'GitlabController@getAccounting');
    Route::get('/accounting-commits/{accounting_name}/{group_name}', 'GitlabController@getAccountingCommits');
});
