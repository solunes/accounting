...
class PlaceMovement extends Model {
    ...
    public function place_to() {
        return $this->belongsTo('Solunes\Accounting\App\Place', 'place_to_id');
    }
            
    public function place_from() {
        return $this->belongsTo('Solunes\Accounting\App\Place', 'place_from_id');
    }
    ...
    public function account_to() {
        return $this->belongsTo('Solunes\Accounting\App\Account', 'account_to_id');
    }
            
    public function account_from() {
        return $this->belongsTo('Solunes\Accounting\App\Account', 'account_from_id');
    }
