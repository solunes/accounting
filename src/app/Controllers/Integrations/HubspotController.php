...
class HubspotController extends Controller {
	...
	/*public function getImportDeals() {
		...
		foreach($items as $item){
	        ...
	        $main_array = \Accounting::importHubspotProperty($properties, $array);
		...
		\Accounting::generateDeal($main_array, $main_array['id'], $company_ids, $contact_ids);
		return ['created'=>true];
	}*/
	...
	/*public function postDealCreated($id) {
		...
		\Accounting::generateDeal($main_array, $id, $company_ids, $contact_ids);
		return ['created'=>true];
	}*/

	// Export Company to HubSpot
	public static function exportCompanyCreated($id) {
		$item = \Solunes\Accounting\App\Company::find($id);
        $array = $this->company_fields;
	...
	public static function exportContactCreated($id) {
		$item = \Solunes\Accounting\App\Contact::find($id);
        $array = $this->contact_fields;
	...
	/*public static function exportDealCreated($id) {
		$item = \Solunes\Accounting\App\Deal::find($id);
		\Accounting::exportDeal($item);
		return ['created'=>true];
	}*/
	...
	public function initiateHubspot() {
		$hubspot = \SevenShores\Hubspot\Factory::create(config('accounting.hubspot_api_key'));
		return $hubspot;
	}
